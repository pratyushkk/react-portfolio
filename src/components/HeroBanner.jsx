    ...
    >
      ...
      <Wrapper>
        ...
        <motion.div
          ...
          transition={{ duration: 0.7, delay: 0.25 }}
        >
          <div className="font-light mb-1 text-xl">
            👋 Hi, I Am <span className="font-semibold text-4xl">Pratyush</span>
          </div>
          {/* <div className="max-w-[510px]">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta
            cumque illum non rerum fugit eius vel qui hic itaque nesciunt
            assumenda corrupti dolor quae quibusdam corporis, sed ut,
            perspiciatis cupiditate tempore distinctio dolores reiciendis.
            Debitis possimus reprehenderit aut nostrum omnis totam consequuntur
            officiis, deleniti id, dolore, saepe dolor esse aliquam.
          </div> */}
        </motion.div>
        {/* INTRO END */}

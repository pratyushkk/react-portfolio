    ...
    <div id="work" className="mt-10 relative">
      ...
      <Div className="mb-10">
        ...
        <div className="text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] text-[#CCCCCC] text-center">
          👇 Dive into the code! Click the image below to explore the GitHub
          repository!
        </div>
      </Div>
      {/* SECTION HEADING END */}
                ...
                <img
                  ...
                  onClick={() => {
                    if (item.link) {
                      ...
                      // Handle the case where item.link is not provided
                      console.error("No link provided for this item.");
                    }
                  }}

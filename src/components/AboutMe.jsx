    ...
    >
      ...
      <Wrapper>
        ...
        <Div className="max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
          👋 Hey there, I'm Pratyush, a results-driven Web Developer
          specializing in React.js, JavaScript, Redux, HTML, CSS, SCSS, and
          Tailwind CSS. <br /> <br /> 🚀 I excel at transforming concepts into
          pixel-perfect, user-friendly interfaces. My skill set empowers me to
          architect seamless experiences that leave a lasting impression. <br />
          <br />
          💡 Over the years, I've collaborated with diverse teams, bringing
          projects from ideation to fruition. I specialize in responsive design,
          state management, and API integration for efficient data flow. <br />
          <br />
          🌐 Committed to staying ahead of tech trends, I'm an avid learner
          always eager for new challenges. <br />
          <br />
          🌟 Let's connect! I'm open to opportunities, discussions, or simply
          geeking out about frontend development.
        </Div>
        {/* PARAGRAPH END */}
